...
public class MainJuego extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Chura Rodriguez Marco Stefano");
        ...
        boton4.setBackground(new java.awt.Color(153, 153, 0));
        ...
        boton7.setBackground(new java.awt.Color(153, 0, 0));
        boton7.setFont(new java.awt.Font("Tahoma", 3, 56)); // NOI18N
        boton7.setEnabled(false);

        boton8.setBackground(new java.awt.Color(0, 0, 255));
        boton8.setFont(new java.awt.Font("Tahoma", 3, 56)); // NOI18N
        boton8.setEnabled(false);

        boton9.setBackground(new java.awt.Color(102, 0, 102));
        ...
        boton1.setForeground(new java.awt.Color(153, 153, 153));
        ...
        Anular.setBackground(new java.awt.Color(51, 51, 255));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre Partida", "Player1 1", "Player2", "Nombre Ganador", "Puntuación", "Estado"
            }
        ));
